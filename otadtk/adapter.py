...
checkpoints for the encoders bundled with otadtk are downloaded on demand from
an anonymous hosting URL (see ``_checkpoints.py``).
"""
...
def load_adapter(
    ...
    *,
    ...
    The checkpoint is resolved in this order:
      ...
      3. The package's anonymous hosting URL (auto-download).
